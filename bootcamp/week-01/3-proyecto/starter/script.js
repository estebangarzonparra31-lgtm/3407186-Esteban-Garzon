...
console.log('=========================================');
console.log('[plataforma de salud mental] - FICHA DE PRESENTACIÓN');
console.log('=========================================');
console.log('');
...
console.log('Categoría:       [bienestar psicologico]');
...
console.log('Valor principal:    78');
...
console.log('Valor calculado:    ', 30 * 2); // TODO: reemplaza 0 con tu cálculo
...
console.log('Total registros:  [89]');
...
console.log('[cuida tu salud mental con javaScript]');
